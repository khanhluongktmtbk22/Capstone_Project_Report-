...
\subsubsection*{UC03 -- Quản lý lịch nhắc nhở}
...
\subsection*{Phụ lục B -- Cấu trúc dữ liệu và giao thức truyền thông}
\addcontentsline{toc}{subsection}{Phụ lục B -- Cấu trúc dữ liệu và giao thức truyền thông}
...
\hline
ReminderService & Theo dõi lịch và phát sự kiện nhắc nhở \\
\hline
...
\hline
Schedule/\allowbreak AddScheduleFragment & Thêm, đọc, cập nhật và xóa lịch nhắc nhở \\
\hline
