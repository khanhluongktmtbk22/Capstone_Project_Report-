...
\fancypagestyle{reportstyle}{%
  \fancyhf{}
  \fancyhead[L]{\includegraphics[height=10mm]{bk_name_vi.png}}
  \fancyhead[R]{%
...
\clearpage
\input{Contents/HienThucHeThong}
\clearpage
\input{Contents/KetQuaVaThaoLuan}
\clearpage
