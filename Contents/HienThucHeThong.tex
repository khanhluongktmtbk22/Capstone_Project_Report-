...
Quy trình xử lý sử dụng bốn hệ tọa độ như trình bày trong Bảng \ref{tab:yolo_coordinate_systems}. Hộp bao và các điểm khớp phải được chuyển đổi nhất quán giữa các hệ này. Các phép tính theo dõi và điều khiển sử dụng tọa độ ảnh camera; tọa độ trên giao diện chỉ phục vụ hiển thị.
...
Hàm chi phí ghép đối tượng gồm bốn thành phần: 30\% sai khác IoU, 30\% khoảng cách tâm, 30\% khoảng cách giữa các điểm khớp và 10\% thay đổi diện tích hộp bao. Ngưỡng IoU cơ sở của bộ theo dõi là 0,25; đối tượng mới cần hai lần ghép thành công để được xác nhận. Khi không tìm thấy kết quả phát hiện phù hợp, định danh ID0 được duy trì tối đa 45 khung hình, còn các định danh khác được giữ tối đa 10 khung hình.
...
Người mục tiêu được gán định danh \texttt{PRIMARY\_TRACK\_ID=0}. Việc lựa chọn ban đầu dựa trên diện tích hộp bao, độ tin cậy phát hiện, tỷ lệ điểm khớp quan sát được, khoảng cách đến tâm ảnh và mức độ bị cắt ở biên. Định danh ID0 được dùng chung cho phân tích té ngã và điều khiển bám theo. Khi mất dấu, hệ thống tìm lại mục tiêu trong khoảng 2 s; đối tượng được xét phải cách vị trí cuối không quá 35\% đường chéo ảnh, nằm trong vùng trung tâm và được quan sát ổn định qua ba khung hình. Trong quá trình xử lý sự kiện nghi té ngã, hệ thống không tự chuyển sang một người khác.

Chức năng bám theo ước lượng độ gần từ kích thước hộp bao và khoảng cách giữa các mốc vai, hông, gối, mắt cá chân. Giá trị sau khi làm mượt được chia thành ba vùng quá xa, phù hợp và quá gần. Ngưỡng đi vào và rời khỏi mỗi vùng khác nhau để tránh chuyển liên tục giữa tiến, dừng và lùi khi giá trị dao động gần biên. \texttt{TrackingMotionPolicy} điều chỉnh thành phần tịnh tiến theo độ gần: mức tiến tăng từ 0,60 đến 0,90, mức lùi khi mục tiêu quá gần thay đổi từ 0,45 đến 0,60, còn mức lùi để quan sát lại phần chân là 0,30. Đây là các độ lớn của lệnh điều khiển chuẩn hóa, không phải vận tốc đo bằng m/s. Khi robot vừa quay vừa tiến hoặc chưa quan sát ổn định mắt cá chân, mức tiến được giảm để hạn chế mất dấu. Sai lệch ngang giữa tâm hộp bao và tâm ảnh tạo thành phần quay liên tục, có vùng chết và giới hạn biên để giảm dao động.
