...
Pipeline thị giác kết hợp mô hình pose với tracking-by-detection, Kalman, Hungarian và Re-ID nhẹ. Người cần chăm sóc được bảo vệ dưới ID0; chỉ ID0 đi vào LSTM. Model LSTM xử lý cửa sổ 15 khung hình với 69 đặc trưng, sau đó máy trạng thái và bộ hậu kiểm dùng các bằng chứng vùng bao, keypoint, tư thế, vị trí thân trên và mất dấu. Khi cần xác nhận, robot dừng, hỏi bằng giọng nói và mặc định theo nhánh nguy hiểm nếu người dùng không phản hồi hoặc dịch vụ phân loại lỗi.
...
\begin{itemize}
    ...
    \item Thiết kế khóa mục tiêu ID0, khôi phục có điều kiện và bộ hậu kiểm sự cố có lý do/bằng chứng.
...
Re-ID histogram chỉ là đặc trưng ngoại hình nhẹ. Khi nhiều người mặc giống nhau, ID0 có thể mất hoặc ghép sai. Các ngưỡng hậu kiểm được thiết lập theo kinh nghiệm và cần calibration theo vị trí camera. Firmware parser còn dựa vào \texttt{String.toFloat}; cơ cấu robot cần nút dừng vật lý, bảo vệ dòng/điện áp và kiểm thử cơ khí. APK RobotApp debug lớn và cần tối ưu đóng gói.
