...
Trong các công trình từ năm 2024 trở lại đây, hai hướng thị giác nổi bật tiếp tục được phát triển song song. Hướng thứ nhất cải tiến các bộ phát hiện một giai đoạn để nhận biết trực tiếp người ở trạng thái ngã \reportcite{ref:falldetection}; hướng thứ hai khai thác keypoint và diễn biến tư thế, kết hợp thêm theo dõi hoặc mô hình thời gian để phân biệt cú ngã với những hoạt động có hình dạng tương tự \reportcite{ref:hfdmia_pose}\reportcite{ref:yosap_lstm}\reportcite{ref:fallnet}. Xu hướng này phù hợp với yêu cầu xử lý thời gian thực nhưng cũng đặt ra bài toán về độ ổn định của keypoint, che khuất và khả năng chạy trên phần cứng có tài nguyên giới hạn.

\paragraph{Phương pháp sử dụng thiết bị đeo.}
