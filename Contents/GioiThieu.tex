...
CAUCAFall cung cấp video trong môi trường ít kiểm soát, có nhãn fall/no-fall và mô tả khoảng cách, góc rơi, độ chiếu sáng; dữ liệu phù hợp cho cả detector và phương pháp dựa trên bản đồ xương \reportcite{ref:caucafall}. DiverseFALL10500 bổ sung khoảng 10.500 ảnh có chú thích với đa dạng môi trường, ánh sáng, trang phục và độ tuổi \reportcite{ref:falldetection}. So với detector chỉ phân lớp một khung hình, đề tài sử dụng pose theo thời gian, theo dõi một người mục tiêu và hậu kiểm sự cố để giảm nhầm lẫn giữa nằm chủ động, ngồi thấp, che khuất và té ngã.
