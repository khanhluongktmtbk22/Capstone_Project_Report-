...
Các hệ thống phát hiện té ngã đã được nghiên cứu với nhiều nguồn dữ liệu, từ tín hiệu thu trực tiếp trên cơ thể đến âm thanh, radar, ảnh chiều sâu và video RGB. Trong tập công trình được bài tổng quan năm 2023 khảo sát, nhóm dựa trên tín hiệu y sinh chiếm 22,69\%, tiếp theo là nhóm dựa trên thị giác với 20,87\% \reportcite{ref:newaz_fall_review}. Mức độ xuất hiện tương đối lớn của hai nhóm cho thấy tín hiệu cơ thể và hình ảnh đều là những nguồn thông tin có tiềm năng. Tuy nhiên, các tỷ lệ này phản ánh xu hướng nghiên cứu chứ không phải thứ hạng về độ chính xác, bởi mỗi công trình sử dụng dữ liệu, đối tượng và quy trình đánh giá khác nhau.
...
Các bộ phát hiện đối tượng, mô hình ước lượng tư thế và mạng xử lý chuỗi ngày càng đáp ứng tốt hơn yêu cầu suy luận trên thiết bị biên. Từ năm 2024, nhiều nghiên cứu đã chuyển từ quyết định trên một khung hình sang khai thác điểm mốc khớp (keypoint), duy trì định danh người và phân tích diễn biến tư thế theo thời gian \reportcite{ref:falldetection}\reportcite{ref:hfdmia_pose}\reportcite{ref:yosap_lstm}\reportcite{ref:fallnet}. Với yêu cầu đồng thời phát hiện té ngã và theo dõi mục tiêu, thị giác phù hợp hơn với kiến trúc đề tài; cảm biến đeo và tín hiệu y sinh là hướng bổ sung khi hệ thống được mở rộng.
...
Camera cung cấp nhiều thông tin hơn một tín hiệu chuyển động đơn lẻ: từ video, hệ thống có thể xác định vị trí người, hộp bao (bounding box), các điểm khớp, tốc độ hạ thấp cơ thể và trạng thái sau va chạm. Khung hình gắn với sự kiện còn giúp người chăm sóc quan sát lại tình huống khi cần thiết. Sự phổ biến của camera tích hợp và bộ xử lý di động làm cho hướng tiếp cận này ngày càng phù hợp với xử lý tại biên. Tuy nhiên, chất lượng nhận biết vẫn chịu ảnh hưởng của ánh sáng, góc nhìn, che khuất và chuyển động nền; dữ liệu hình ảnh cũng đòi hỏi nguyên tắc bảo vệ quyền riêng tư rõ ràng.

Các phương pháp thị giác ban đầu thường dùng vùng bóng người tách khỏi nền (silhouette), tỷ lệ chiều cao--chiều rộng, hướng trục chính hoặc lịch sử chuyển động. Một hướng khác là dòng quang học (optical flow), biểu diễn sự dịch chuyển của điểm ảnh giữa các khung hình. Núñez-Marcos, Azkune và Arganda-Carreras xếp chồng các ảnh dòng quang học rồi dùng CNN dựa trên VGG-16 để phân lớp đoạn video \reportcite{ref:opticalflow_fall}. Cách này nắm được động học tốt hơn ảnh tĩnh, nhưng bước tính dòng quang học tốn tài nguyên và đặc biệt nhạy với chuyển động camera của robot.

Với bộ phát hiện một giai đoạn, ảnh RGB đi qua mạng YOLO, được lọc theo độ tin cậy và loại bớt các hộp trùng lặp bằng NMS để trả về vị trí người ngã. Công trình ``Visionary Vigilance'' xây dựng DiverseFALL10500 với khoảng 10.500 ảnh đa dạng và tối ưu YOLOv8s bằng Focus cùng CBAM \reportcite{ref:falldetection}. Cách phát hiện trực tiếp trên ảnh có ưu thế về tốc độ và khả năng định vị sự cố, nhưng một tư thế nằm trong ảnh đơn chưa chứng minh đã xảy ra quá trình té ngã: người dùng có thể nằm nghỉ, cúi nhặt đồ, tập thể dục hoặc bị quan sát ở góc bất lợi. Vì vậy, độ chính xác theo khung hình cao vẫn có thể đi kèm nhiều cảnh báo giả khi camera hoạt động trong thời gian dài.

Ước lượng tư thế (pose estimation) biểu diễn mỗi người bằng tập keypoint $(x,y,c)$, trong đó $(x,y)$ là tọa độ điểm khớp và $c$ là độ tin cậy. Sau khi chuẩn hóa theo hộp người hoặc kích thước cơ thể, hệ thống có thể tạo các đặc trưng như góc thân, tỷ lệ chiều cao--chiều rộng, độ cao tương đối và vận tốc của hông, vai, gối. So với ảnh RGB nguyên gốc, biểu diễn khung xương (skeleton) giảm phụ thuộc vào màu quần áo và nền, đồng thời làm rõ diễn biến động học. Tuy nhiên, che khuất và góc nhìn xấu có thể làm mất keypoint; bởi vậy tư thế phải được gắn với đúng track trước khi ghép thành chuỗi. Juraev và cộng sự cũng chỉ ra các khó khăn về thiếu dữ liệu ngã thực, thay đổi góc camera, ánh sáng và che khuất; dữ liệu tổng hợp có thể hỗ trợ, nhưng mô hình thời gian vẫn phải được kiểm chứng trong bối cảnh triển khai thực tế \reportcite{ref:pose_synthetic}.
...
Phát hiện người chỉ cho biết vị trí của các đối tượng trong từng khung hình, còn theo dõi phải nối các kết quả đó theo thời gian. Mỗi chuỗi kết quả được gọi là một \emph{track} và được gắn một mã định danh (track ID). Đối với robot bám người, track ID cần đủ ổn định để robot không chuyển sang một người khác khi nhiều người đi gần nhau hoặc khi mục tiêu bị che khuất trong thời gian ngắn. Tính nhất quán này cũng cần thiết cho phát hiện té ngã, vì các điểm khớp thuộc nhiều người không thể ghép chung thành một chuỗi đầu vào cho mô hình thời gian.

Kịch bản sử dụng chính của đề tài là hỗ trợ người cao tuổi tại nhà, trong đó robot ưu tiên một người dùng và di chuyển theo họ để duy trì quan sát. Vì hình ảnh được thu liên tục từ vị trí tương đối gần, mục tiêu thường xuất hiện ở các khung hình kế tiếp với thay đổi không quá đột ngột; tình huống mất dấu kéo dài rồi tái xuất hiện giữa đám đông không phải yêu cầu trọng tâm như trong hệ thống camera giám sát công cộng. Bài toán theo dõi vì thế tập trung vào việc giữ ổn định một mục tiêu, xử lý những khoảng mất dấu ngắn do quay người hoặc che khuất, đồng thời tránh phát lệnh di chuyển khi độ tin cậy không còn bảo đảm.

\paragraph{SORT.}
SORT (Simple Online and Realtime Tracking) là phương pháp \emph{tracking-by-detection}, nghĩa là theo dõi dựa trên các hộp người do bộ phát hiện tạo ra ở từng khung hình. Bộ lọc Kalman dự đoán vị trí tiếp theo của mỗi track từ trạng thái chuyển động trước đó. Kết quả dự đoán được so với các hộp mới bằng IoU, tức tỷ lệ phần diện tích giao trên diện tích hợp của hai hộp. Từ ma trận chi phí này, thuật toán Hungarian tìm cách ghép một--một giữa các track và các phát hiện sao cho tổng chi phí nhỏ nhất \reportcite{ref:sort}\reportcite{ref:kalman}\reportcite{ref:hungarian}. Các cặp hợp lệ được cập nhật, phát hiện chưa được ghép tạo track mới, còn track mất dấu quá lâu sẽ bị loại bỏ.

Ưu điểm của SORT là cấu trúc gọn, không cần huấn luyện thêm mạng theo dõi và có thể xử lý trực tuyến theo từng khung hình. Đây là đặc điểm phù hợp với điện thoại phải đồng thời chạy mô hình tư thế, nhận dạng té ngã và các chức năng của RobotApp. Tuy nhiên, SORT nguyên bản chủ yếu dựa vào chuyển động và mức chồng lấp của hộp nên có thể đổi ID khi người bị che khuất, thay đổi tư thế mạnh hoặc khi camera trên robot đang di chuyển.

\paragraph{Deep SORT.}
Deep SORT bổ sung \emph{Re-Identification} (Re-ID), tức nhận dạng lại một người dựa trên đặc trưng ngoại hình. Một mạng học sâu biến vùng ảnh của mỗi người thành vector đặc trưng (embedding), sau đó kết hợp độ tương đồng ngoại hình với dự đoán chuyển động để nối lại track sau che khuất \reportcite{ref:deepsort}. Cách này thường giảm hiện tượng đổi ID so với SORT, nhưng mỗi hộp người cần thêm một lượt suy luận. Chi phí bộ nhớ và tính toán vì thế tăng lên, trong khi kết quả vẫn có thể suy giảm khi ánh sáng thay đổi, vùng người quá nhỏ hoặc nhiều người mặc trang phục tương tự. Lợi ích của mạng Re-ID sâu không đủ lớn trong kịch bản một người dùng được robot quan sát liên tục, nên Deep SORT chỉ được dùng làm phương án đối chiếu.

\paragraph{Từ theo dõi đến bám người.}
Theo dõi nhiều người mới chỉ tạo ra các track; robot còn phải chọn và duy trì một mục tiêu chính. Từ hộp bao và các điểm khớp của mục tiêu, hệ thống xác định độ lệch trái--phải trong khung hình để điều chỉnh hướng quay, đồng thời ước lượng mức gần--xa để giữ khoảng cách phù hợp. Luồng xử lý có thể khái quát thành \textit{thu nhận ảnh $\rightarrow$ phát hiện và theo dõi người $\rightarrow$ khóa mục tiêu $\rightarrow$ xác định sai lệch vị trí và khoảng cách $\rightarrow$ tạo lệnh chuyển động}. OpenBot cho thấy điện thoại thông minh có thể đảm nhiệm khối quan sát, tính toán và gửi lệnh xuống thân xe \reportcite{ref:openbot}; cách phân chia này phù hợp với kiến trúc robot của đề tài.

Từ các phương pháp trên, SORT được chọn làm nền tảng vì có cấu trúc gọn và phù hợp với tính liên tục của mục tiêu trong kịch bản sử dụng. Để tăng độ ổn định mà không cần thêm mạng Re-ID sâu, bước liên kết của đề tài còn tham khảo khoảng cách tâm, tỷ lệ kích thước, các điểm khớp cơ thể và đặc trưng màu HSV bên cạnh IoU. HSV là không gian màu tách tương đối rõ sắc độ và độ bão hòa; histogram HSV mô tả phân bố màu trong vùng người và hỗ trợ nối lại mục tiêu sau một khoảng mất dấu ngắn. Mục tiêu chính được giữ bằng một ID thống nhất để cả điều khiển bám người và chuỗi phát hiện té ngã cùng sử dụng. Khi bằng chứng về mục tiêu không còn đủ tin cậy, robot dừng chuyển động thay vì tự động chuyển sang một người khác.

Bảng~\ref{tab:tracking_related} chỉ giữ các phương pháp có liên hệ trực tiếp với quyết định thiết kế của đề tài.
...
\hline
Deep SORT & Chuyển động và embedding ngoại hình & Giảm đổi ID; cần suy luận đặc trưng và tài nguyên lớn hơn & Phương án đối chiếu; chưa cần thiết với một mục tiêu được quan sát liên tục \\
\hline
Hướng của đề tài & Kalman và Hungarian kết hợp hình học, tư thế và histogram HSV & Không cần mạng Re-ID sâu; vẫn phụ thuộc góc nhìn, ánh sáng và trang phục & Phù hợp bám một mục tiêu và xử lý trên điện thoại \\
\hline
\end{tabularx}
\end{table}
...
Một lượt hội thoại hoàn chỉnh thường đi qua chuỗi \textit{kích hoạt $\rightarrow$ thu âm $\rightarrow$ chuyển tiếng nói thành văn bản (STT) $\rightarrow$ mô hình ngôn ngữ lớn (LLM) $\rightarrow$ chuyển văn bản thành tiếng nói (TTS) $\rightarrow$ phát âm thanh}. STT, LLM và TTS lần lượt đảm nhiệm việc tiếp nhận lời nói, tạo nội dung phản hồi và đọc câu trả lời cho người dùng. Bên cạnh ba khối này, ứng dụng còn cần phát hiện khoảng lặng, quản lý lịch sử hội thoại, ngắt câu trả lời đang phát, xử lý mất mạng và biểu diễn trạng thái để người dùng biết robot đang nghe, xử lý hay nói. Chất lượng trải nghiệm vì thế phụ thuộc vào độ trễ đầu cuối và cách phối hợp các thành phần, không chỉ vào chất lượng văn bản do LLM sinh ra.
...
Với mục tiêu tạo một người bạn trò chuyện bằng tiếng Việt trên điện thoại Android, phương án kết hợp dịch vụ nhận dạng và tổng hợp tiếng nói của hệ điều hành với LLM qua API có ưu thế về dung lượng, chi phí thử nghiệm và khả năng triển khai trên nhiều thiết bị. Trong nguyên mẫu, tên gọi của robot được sử dụng để bắt đầu lượt trao đổi; văn bản nhận dạng được gửi tới Groq API và phản hồi dạng streaming được chuyển dần sang Android TTS. Hội thoại được tổ chức theo các trạng thái nghe, xử lý và phát lời để người dùng dễ nhận biết robot đang thực hiện bước nào, đồng thời hạn chế việc hệ thống thu lại chính câu trả lời vừa phát.
...
SocialRobot là một ví dụ về robot di động hỗ trợ chăm sóc theo hướng lấy người dùng làm trung tâm. Nền tảng kết hợp khả năng di chuyển và cảm nhận tại chỗ với hệ thống quản lý hồ sơ, dịch vụ cá nhân hóa và nhóm chăm sóc từ xa \reportcite{ref:socialrobot}. Điểm đáng tham khảo là người thân và người chăm sóc được xem như những tác nhân tham gia thường xuyên vào quá trình hỗ trợ, thay vì chỉ nhận thông báo sau khi sự cố đã xảy ra. Cách tiếp cận này phù hợp với nhu cầu chăm sóc người cao tuổi sống một mình, vì robot tại nhà và người chăm sóc từ xa có thể bổ trợ cho nhau.

OpenBot tiếp cận bài toán từ hướng đơn giản hóa nền tảng robot: điện thoại thông minh đảm nhiệm cảm nhận, tính toán, giao diện và kết nối, còn phần thân xe tập trung thực hiện lệnh chuyển động \reportcite{ref:openbot}\reportcite{ref:openbot_repo}. Cách tổ chức này làm giảm số phần cứng chuyên dụng và tạo điều kiện thuận lợi cho học tập, thử nghiệm. Từ nền tảng này, đề tài kế thừa tư tưởng sử dụng điện thoại làm trung tâm xử lý, nhưng điều chỉnh mục tiêu sang hỗ trợ người cao tuổi tại nhà. RobotApp đảm nhiệm tương tác và quan sát tại chỗ, ứng dụng dành cho người chăm sóc tạo kênh theo dõi từ xa, còn thân robot bảo đảm khả năng di chuyển theo quyết định của hệ thống.
