...
Đối tượng kỹ thuật của đề tài gồm nền tảng robot sử dụng điện thoại thông minh làm bộ xử lý chính; hai ứng dụng Android dành cho robot và người chăm sóc; thị giác máy tính và học sâu trên thiết bị; bài toán theo dõi đối tượng và phân tích chuỗi tư thế; công nghệ tổng hợp tiếng nói (Text-to-Speech--TTS) và chuyển giọng nói thành văn bản (Speech-to-Text--STT); mô hình ngôn ngữ lớn; các phương thức đồng bộ dữ liệu và truyền thông thời gian thực; kết nối giữa điện thoại với robot; thiết kế firmware cho hệ thống điều khiển phần thân robot; cùng quy trình chuyển đổi mô hình AI để triển khai trên thiết bị di động.
