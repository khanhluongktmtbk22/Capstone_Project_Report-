...
\hline
RGB một khung hình & Bounding box và đặc trưng hình ảnh của người & Nhanh, định vị trực tiếp, tận dụng camera sẵn có & Dễ nhầm nằm/cúi; nhạy ánh sáng, góc nhìn và che khuất \\
\hline
...
Trong hệ thống của đề tài, người xuất hiện trong vùng quan sát được đánh giá dựa trên kích thước bounding box, độ tin cậy của phép phát hiện, số keypoint nhìn thấy và vị trí trong khung hình. Người có chất lượng quan sát tốt nhất được chọn làm mục tiêu chính và được duy trì trong các khung hình tiếp theo. Vị trí tâm của bounding box cho biết độ lệch theo phương ngang để robot điều chỉnh hướng quay, còn kích thước bounding box kết hợp với khoảng cách giữa các keypoint trên cơ thể được dùng để ước lượng mức độ gần--xa. Từ hai đại lượng này, hệ thống xác định thành phần chuyển động tiến--lùi và thành phần điều hướng, sau đó làm mượt lệnh nhằm hạn chế rung khi mục tiêu dao động quanh vùng cân bằng.
